...
object centeredStroke extends StrokeType(JStrokeType.\iCENTERED) {}
...
object insideStroke extends StrokeType(JStrokeType.\iINSIDE) {}

"The stroke is applied by extending the boundary of the [[Shape]] node outside of its interior
 by a distance specified by the strokeWidth."
object outsideStroke extends StrokeType(JStrokeType.\iOUTSIDE) {}
...
object squareLineCap extends StrokeLineCap(JStrokeLC.\iSQUARE) {}
...
object bevelLineJoin extends StrokeLineJoin(JStrokeLJ.\iBEVEL) {}

"Joins path segments by extending their outside edges until they meet."
object miterLineJoin extends StrokeLineJoin(JStrokeLJ.\iMITER) {}

"Joins path segments by rounding off the corner at a radius of half the line width."
object roundLineJoin extends StrokeLineJoin(JStrokeLJ.\iROUND) {}
